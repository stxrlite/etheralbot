...
module.exports = {
    ...
    .addSubcommand(command => command.setName('stats').setDescription('Shows The Stats'))
    .addSubcommand(command => command.setName('specs').setDescription('Shows The Specs Of The Bot'))
    .addSubcommand(command => command.setName('ping').setDescription(`Simple Ping Command`))
    .addSubcommand(command => command.setName('online').setDescription(`Checks The Bots Activity`)),
    async execute(interaction, client) {
        ...
        .addComponents(
            new ButtonBuilder()
            .setLabel('Space Software Solutions') // Change To Any Name You Want
            .setStyle(ButtonStyle.Link)
            .setURL("https://discord.gg/2GrWjDZRQN"), // Change To Any Server You Want
 
            new ButtonBuilder()
            .setLabel('Bot Invite')
            .setStyle(ButtonStyle.Link)
            .setURL("https://cdn.discordapp.com/attachments/1089863360457211904/1096162251955777596/astronaut-screen-printing-space-illustration_116298-308.png") // Space Bot Doesn't Use An Invite Link If You Choose To You Can Put A Developer Portal Link Here
        )
        ...
        .setThumbnail('https://cdn.discordapp.com/attachments/1089863360457211904/1096162251955777596/astronaut-screen-printing-space-illustration_116298-308.png') // You Can Change To Any .png File
        ...
        .setThumbnail('https://cdn.discordapp.com/attachments/1089863360457211904/1096162251955777596/astronaut-screen-printing-space-illustration_116298-308.png') // Same Here
